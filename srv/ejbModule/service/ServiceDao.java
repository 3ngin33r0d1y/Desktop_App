...
public class ServiceDao implements ServerDaoRemote, ServerDaoLocal {
	...
	//*****************Crud User****************************
		...
		public boolean update(User b,String n,String p,String e,String t,Date d) {
			em.createQuery("update User b set b.nom = :x, b.prenom = :x1, b.email = :x2, b.tel = :x3, b.date = :x4 where b.idUser = :y").setParameter("x", n).setParameter("x1", p).setParameter("x2", e).setParameter("x3", t).setParameter("x4", d).setParameter("y",b.getIdUser()).executeUpdate();
